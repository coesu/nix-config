...
return {
	...
	s(
		{ name = "Align Math", trig = "alm", snippetType = "autosnippet" },
		fmta(
			[[
                <>
                $$
	...
	s(
		{ name = "Cases Math", trig = "csm", snippetType = "autosnippet" },
		fmta(
			[[
                <>
                $$
	...
	s(
		{ name = "Align Math", trig = "alim", snippetType = "autosnippet" },
		fmta(
			[[
                <>
                $$
	...
	s(
		{ name = "Q&A", trig = "qa", snippetType = "autosnippet" },
		fmta(
			[[
                    **Q<>:** <>
                    **A:** <>
	...
	s(
		{ name = "File Link", trig = "fll", snippetType = "autosnippet" },
		fmta("[[./<>|<>]]", {
			i(1),
			d(2, get_visual),
		})
