...
return {
	-- NEW FIGURE, AXES
	s(
		{ trig = "fx", snippetType = "autosnippet" },
	...
	-- PLTSHOW
	s(
		{ trig = "pltsh", snippetType = "autosnippet" },
		fmta([[plt.show()<>]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	...
	-- PLTSAVEFIG
	s(
		{ trig = "pltsv", snippetType = "autosnippet" },
		fmta([[plt.savefig("<>.pdf", bbox_inches='tight')]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	),
	-- PLTHIST
	s(
		{ trig = "plthi", snippetType = "autosnippet" },
		fmta([[plt.hist(<>)]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	...
	-- PLTPLOT
	s(
		{ trig = "pltp", snippetType = "autosnippet" },
		fmta([[plt.plot(<>)]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	...
	-- AXIS SET_XLABEL
	s(
		{ trig = "xxl", snippetType = "autosnippet" },
		fmta([[ax.set_xlabel(<>)]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	...
	-- AXIS SET_YLABEL
	s(
		{ trig = "xyl", snippetType = "autosnippet" },
		fmta([[ax.set_ylabel(<>)]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
	...
	-- AXIS SET_TITLE
	s(
		{ trig = "xt", snippetType = "autosnippet" },
		fmta([[ax.set_title(<>)]], {
			d(1, get_visual),
		}),
		{ condition = line_begin }
